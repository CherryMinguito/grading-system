    ...
    <div>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <router-link to="/Dashboard" class="text-decoration text-center text-white">DASHBOARD</router-link>
            </li>
            ...
            <li class="nav-item nav-link">
                <router-link to="/Students" class="text-white text-decoration text-center">Students</router-link>
            </li>
                <div>
                    <router-link to="/" class="text-white text-decoration text-center">Logout</router-link>
                </div>
        </ul>
    </div>
</template>
