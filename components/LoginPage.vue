                                ...
                                <div class="col-lg-12">
                                    <div class="p-4">
                                        ...
                                        <div class="text-center">
                                            <img src="https://imgs.search.brave.com/JIVxbc5SvnH2mleJOQvSFERlvlkcNFV9Y0K1ip5lm7c/rs:fit:300:300:1/g:ce/aHR0cHM6Ly93d3cu/ZG90Y29tLW1vbml0/b3IuY29tL2Jsb2cv/d3AtY29udGVudC91/cGxvYWRzL3NpdGVz/LzMvMjAyMC8wNS9W/dWUtbG9nby0xLnBu/Zw" alt="logo" width="150px" height="150px">
                                        ...
                                        <form class="user">
                                            ...
                                            <router-link to="/Dashboard" class="btn-primary btn-block" tag="button">Login</router-link>
                                            <router-link to="/Dashboard" class="btn btn-primary btn-block" tag="button">Login</router-link>                                            
                                        </form>
                                        <hr>
...
@media (min-width: 1200px) {
  .container, .container-sm, .container-md, .container-lg, .navbar .container,
