                ...
                <div>
                    ...
                    <b-modal class="modal" id="modal-1" title="Add New Student" hide-footer>
                        ...
                        <div id="modal-1___BV_modal_footer_" class="modal-footer">
                            <button type="button" id="btn_add" class="btn btn-primary" v-on:click="addStudent()">Add
                                Student</button>
                        </div>
                    </b-modal>
                </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="student, count in studentList" :key="student.id">
                            ...
                            <td>
                                <b-button v-b-modal.modal-edit variant="primary" @click="editStudent(student)"
                                    style="margin:0px;">Edit</b-button>
                                <b-button variant="danger" style="margin-left:10px;" @click="deleteStudent(count)">
                                    Delete
                                </b-button>
                            </td>
                            <td></td>
